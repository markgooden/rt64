...
#   if RT_ENABLED
        ...
        void submitRaytracingScene(RenderWorker *worker, RenderFramebufferStorage *fbStorage, RenderTarget *colorTarget, RenderTarget *depthTarget, const RaytracingScene &rtScene);
